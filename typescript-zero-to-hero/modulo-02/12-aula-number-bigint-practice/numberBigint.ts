...
let big1: bigint = 9007199254740991n; // numeral
let big2: bigint = 0b100000000000000000000000000000000000000000000000000011n; // binário
let big3: bigint = 0x20000000000003n; // hexadecimal
let big4: bigint = 0o400000000000000003n; // octal
...
São tipos primitivos que lidam com números, porém, com própositos diferentes.
*/
