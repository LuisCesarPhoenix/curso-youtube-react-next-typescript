...
var nomeCompleto = 'Luis Cesar Gonçalves';
console.log("\n" + nomeCompleto);
// ==> Exemplo 02 - Usando o double quotes (aspas duplas)
var funcaoEmpresa = "Desenolvolvedor Backend Júnior";
console.log("\n" + funcaoEmpresa);
// ==> Exemplo 03 - Usando back ticks (crase) para recuperar os valores das variáveis
var nomeEmpresa = 'Unnel';
var dadosFuncionario = "\nSeja bem-vindo ".concat(nomeCompleto, "! Voc\u00EA ser\u00E1 ").concat(funcaoEmpresa, " \nna empresa ").concat(nomeEmpresa, "\n");
